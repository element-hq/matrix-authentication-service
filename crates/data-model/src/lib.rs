...
pub use self::{
    ...
    users::{
        Authentication, AuthenticationMethod, BrowserSession, LoginSession, MatrixUser, Password,
        User, UserEmail, UserEmailAuthentication, UserEmailAuthenticationCode, UserRecoverySession,
