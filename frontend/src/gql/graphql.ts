...
export type LinkUpstreamProvider_ProviderFragment = { __typename?: 'UpstreamOAuth2Provider', id: string, humanName?: string | null } & { ' $fragmentName'?: 'LinkUpstreamProvider_ProviderFragment' };
